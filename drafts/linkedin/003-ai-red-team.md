...
- Findings that survived adversarial review had **3x more citations** than first-draft findings
- The red team rejected roughly **40% of initial findings** as insufficiently evidenced
